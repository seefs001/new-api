    ...
    const CustomIcon = () => (
        ...
        >
            <path
                ...
                p-id="10970" fill="#2c2c2c" stroke="#2c2c2c" strokeWidth="60"></path>
            <path
                ...
                p-id="10971" fill="#2c2c2c" stroke="#2c2c2c" strokeWidth="20"></path>
        </svg>
    );

    return <span className="inline-flex items-center justify-center">{<CustomIcon />}</span>;
};
